...
**[ブラウザでプレイする](https://ric-op2.github.io/dotmd/)** — インストール不要。全6曲を音付きで遊べます。

キーボード・画面のボタン・ゲームパッドに対応しています。画面下の「タイミング」から、音や光に合わせた測定と手動調整ができます。ハイスコアはゲーム内で保存を選ぶと、使用中のブラウザに残ります。
...
左右を離すと中央車線へ、上を離すと下段へ戻ります。FDS版ではプレイ中にポーズはできません。
